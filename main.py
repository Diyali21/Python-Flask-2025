...
data = [
    {
        "name": "Ultraviolet",
        "pic": "https://th.bing.com/th/id/OIP.flNSw6mAMsxGp7TifdO3XQHaHa?rs=1&pid=ImgDetMain",
    },
    {
        "name": "Nazaratic",
        "pic": "https://th.bing.com/th/id/OIP.otHoQpSdRiYfIQVdYYvW8AAAAA?rs=1&pid=ImgDetMain",
    },
    {
        "name": "Ember Fox",
        "pic": "https://tryhardguides.com/wp-content/uploads/2021/08/focus-icon.png",
    },
]
...
@app.get("/movie-list")
def movie_list_page():
    return render_template("movie-list.html", movie_list=movie_list)
